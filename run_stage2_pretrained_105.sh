...
python main.py \
    ...
    experiment_name=Stage-2_Better-debayer_Small-Gaussian-blur_Single-Head-decoder_Neural-geometry-factor-0.02_Initialize-from-std_Leaky-ReLU_Material-105_run_1 \
    model.stage=2 \
    model.test=False \
