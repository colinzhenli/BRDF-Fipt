...
# ==== ONLY CHANGE THIS ====
ROOT = Path("/media/raid/cloth/No_cable_capture_Sep22/Axis_estimation_Sep22")  # contains scans_0915/ and scan_log_0915.json
# ==========================

SCANS_DIR = ROOT / "images"
LOG_IN = ROOT / "scan_log.json"
LOG_OUT = ROOT / "scan_log_reindexed.json"
