...
python main.py \
    ...
    experiment_name=Stage-2_Bonn-3_Correct-activation_3D-factor_Logrel_Lr-0.01_Decoder-lr-1e-2_From-Real_run_1 \
    ...
    # model.ckpt_path=/media/raid/cloth/output/BRDF/points/L2_All-materials_Latent-dim-16_Large-batch_training_Single-color-head_degree-5_run_2/training/model_0.20_0.20/last_decoder_only.ckpt
