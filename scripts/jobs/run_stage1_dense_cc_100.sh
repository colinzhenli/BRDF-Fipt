...
python main.py \
    ...
    data.training_list_path=/home/zla247/scratch/data/capture_data/training_list_100.txt \
    ...
    experiment_name=Stage1_Nibi_Ours-100-all_Subsample-0.1_Batch-500K_run_1 \
