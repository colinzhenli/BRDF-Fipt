...
python main.py \
    ...
    experiment_name=Stage-2_UBO_fabric09_from-Bonn-Epoch-60_Subsample-0.1_run_1 \
    ...
    model.ckpt_path='/media/raid/cloth/output/BRDF/Bonn_VML/output/Bonn-Theia2/Stage-1_VML_Bonn_Subsample-0.1_Batch-500K_run_1/training/model_0.20_0.20/epoch_59.ckpt'
