...
python main.py \
    ...
    experiment_name=Stage1_No-Chunk_Adam8bit_Dense_Debug_5materials \
    ...
    data.chunk_size=2 \
    data.training_list_path=/home/zla247/projects/BRDF-Fipt/scripts/reformat_data/debug_training_list.txt
