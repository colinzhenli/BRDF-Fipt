...
python main.py \
    ...
    experiment_name=Stage2_Batch-500K_Adam8bit_Bonn${MAT_ID}_from_Bonn_Grazing-angle_run_2 \
    model.stage=2 \
    model.test=False \
    ...
    model.ckpt_path=/media/raid/cloth/output/BRDF/Stage-1-Finals/Bonn.ckpt
