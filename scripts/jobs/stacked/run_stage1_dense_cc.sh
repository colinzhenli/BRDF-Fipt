...
python main.py \
    ...
    data.training_list_path=/home/zla247/scratch/data/capture_data/training_list.txt \
    ...
    experiment_name=Correct-Continue_Continue_Stage1_Fir_Ours-300-all_Subsample-0.1_Batch-500K_run_1 \
