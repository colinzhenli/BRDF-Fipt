#!/bin/bash
# Debug variant of run_stage1_dense.sh
# - 3 materials (training_list_debug3.txt)
# - Few train batches per epoch, 2 epochs total
# - Per-step loss logging
# - Separate experiment name / output to avoid clobbering main runs
# - WandB offline so it doesn't publish to the shared project
...
python main.py \
    ...
    experiment_name=DEBUG_Stage1_Ours-3mat_run \
