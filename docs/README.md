...
python3 webpage/tools/build_manifest.py --no-index

# Custom set
python3 webpage/tools/build_manifest.py --ids 156 249 309 2 50 350
...
python3 webpage/tools/build_manifest.py --ids 156 249 309 428 483
```
...
requests. That works but is slower on first open of each material.
