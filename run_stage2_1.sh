...
python main.py \
    ...
    experiment_name=autodecoder_test_100_gray-plastic \
    ...
    model.ckpt_path=/home/featurize/data/output/points/universal_decoder/training/model_0.20_0.20/last.ckpt \
